...
import tiempo from '../screens/tiempo.png'
    ...
    <main className="pista-page">
      ...
      <section className="pista-card">
        ...
        <div className="pista-text">
          ...
          <p>
            Si escogiste esta opción tienes que estar muy ansiosa jajajaja, pero no te preocupes, los demas planes los haremos otro día, te lo prometo.
          </p>

          <p className="carriage-message">
            (Aunque si luego decides hacer uno de los planes anteriores, lo haremos. TE AMO).
          </p>
        ...
        <div className="address">
          ...
          <p>
            Dirijase a la pantalla anterior, ingresando el código "atras" <br />si es que desea primero hacer un plan de los anteriores
          </p>
